...
class TRStructurePrompt(thought_prompter.ThoughtStructurePrompter):
    ...
    def organize_next_thought_prompt(self, chain_nodes: List[base.BasicNode], **kwargs):
        ...
        generation_prompt = super().organize_next_thought_prompt(chain_nodes)

        generation_prompt.head = root_prompt_str
    ...
    def organize_reasoning_analysis_prompt(self, chain_nodes: List[base.BasicNode]):
        ...
        analysis_prompt_format = self.rollback_prompts.reasoning_analysis_prompt_format
        ...
        analysis_prompt.target = analysis_prompt.target.format(
            self.thought_chain_start_flag, self.rollback_prompts.rollback_solution_flag
        )

        # Record the rollback prompt
        self.rollback_controller_prompt = analysis_prompt
