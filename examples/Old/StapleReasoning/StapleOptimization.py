...
import examples.Old.StapleReasoning.staple_system_prompts as staple_system_prompts
import examples.Old.StapleReasoning.staple_prompts as staple_prompts
...
def _main():
    ...
    pipeline = PlanOptimizationPipeline(reasoner=staple_reasoner)
    pipeline.setup()
    pipeline.load_data()
    pipeline.execute()
